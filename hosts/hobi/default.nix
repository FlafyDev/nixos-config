{
  ...
  sys.hardware.nvidia.package = osConfig.sys.boot.kernelPackages.nvidiaPackages.latest;

  sys = {
    networking.hostName = (builtins.trace config.sys.boot.kernelPackages "hobi");
  };
  ...
  #     };
  #     package = config.sys.boot.kernelPackages.nvidiaPackages.latest;
  #   };
  #   services.xserver = {
  #     videoDrivers = ["nvidia"];
  #     # deviceSection = ''
